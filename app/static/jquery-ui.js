...
function Datepicker() {
	...
	this.regional[""] = { // Default regional settings
		...
		monthNames: ["Led", "Úno", "Bře", "Dub", "Kvě", "Čer", "Červ", "Srp", "Zář", "Říj", "Lis", "Pro"], // For formatting
		dayNames: ["Neděle","Pondělí", "Úterý", "Středa", "Čtvrtek", "Pátek", "Sobota"], // For formatting
		dayNamesMin: ["Ne","Po", "Út", "St", "Čt", "Pá", "So"], // For formatting
		dayNames: ["Su","Mo","Tu","We","Th","Fr","Sa"], // Column headings for days starting at Sunday
